	...
	<c:choose>
		<c:when test="${gh == null || dsGH.size()==0}">
			<div style="align: center; margin: 50px 100px 0px 100px">
				...
				<input type="button" value="Về Trang chủ"
					...
					<div class="col col-md-12">
						<table class="table table-bordered">
								...
								<c:forEach items="${dsGH }" var="i">
									<tr>
										<td class="text-center"><img
											src="<c:url value='resources/img/${i.getAnh()}'/>"
											class="rounded mx-auto d-block" style="width: 50px;"
											alt="..."></td>
							...
							<tbody id="datarow">
								<tr>
									<td></td>
									<td class="text-center">${gh.tongSachHC()}</td>
									<td class="text-center">Tổng tiền</td>
									<td class="text-center">=</td>
									<td class="text-right">${gh.tongTien() }</td>
									<td class="text-left"><a href="GioHang?xoaALL=<%="all"%>"
										class="btn btn-danger btn-delete-sanpham"> <i
						...
						<div>
							<a href="DatMua" class="btn btn-primary btn-md"><i
